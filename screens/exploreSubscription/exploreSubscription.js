...
const ExploreSubscriptionScreen = ({ navigation }) => {
  ...
  function exploreNowButton() {
    return (
      ...
      >
        ...
        >
          <Text style={{ ...Fonts.whiteColor18Bold }}>Explore Now</Text>
        </LinearGradient>
      </TouchableOpacity>
    );
  }
  ...
  function subscribedNowText() {
    return (
      <Text style={styles.subscribedNowTextStyle}>You're Subscribed Now</Text>
    );
  }
      ...
      <View style={{ alignItems: "center" }}>
        ...
        <View style={styles.musicTextStyle}>
          <MaskedView
            ...
            maskElement={<Text style={{ ...Fonts.bold35 }}>Music</Text>}
          >
            <LinearGradient
              start={{ x: 1, y: 0.2 }}
              end={{ x: 1, y: 1 }}
          ...
          <MaskedView
            ...
            maskElement={
              <Text style={{ ...Fonts.blackColor15SemiBold }}>of you</Text>
            }
          >
            <LinearGradient
              start={{ x: 1, y: 0.2 }}
